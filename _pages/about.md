...
# 🔥 Recent News
- *2026.05*: &nbsp;🎉🎉 One paper get accepted in TC.
- *2025.11*: &nbsp;🎉🎉 One paper get accepted in DATE'2026.
- *2025.11*: &nbsp;🎉🎉 One paper get accepted in TACO.
...
- [An IR drop-robust Mapping Method for Reliable Memristive Accelerators](https://ieeexplore.ieee.org/abstract/document/11539583). Jinpeng Liu, Shiyi Song, **Bing Wu**, Huan Cheng, Heng Zhou, Xueliang Wei, Wei Tong and Dan Feng. Corresponding Author. DATE 2026 (CCF-B). Corresponding Author. DATE 2026 (CCF-B).
...
**Journal**
- [pTree: Building Efficient B+-Tree on Non-volatile Memory with Processing-in-memory](https://ieeexplore.ieee.org/abstract/document/11505911). Yibo Liu, **Bing Wu**, Shiyi Song, Xueliang Wei, Huan Cheng, Heng Zhou, Wei Tong, Dan Feng. Corresponding Auther. IEEE TC, 2026 (CCF-A).
- [ICON-NIV: A Generalized Method for Mitigating the Impacts of IR Drop and Nonlinear I-V Effect in eNVM-based Accelerators](https://dl.acm.org/doi/10.1145/3777381). Jinpeng Liu, Wei Tong, **Bing Wu**, Huan Cheng, Heng Zhou, Xueliang Wei, and Dan Feng. Corresponding Author. ACM TACO, 2026 (CCF-A).
...
# My CV
<a href="/docs/BingWu_CV.pdf" target="_blank" rel="noopener noreferrer">Bing Wu's CV</a>.
